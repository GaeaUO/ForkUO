...
namespace Server.Gumps
{
    public class GumpRadio : GumpEntry
    {
        ...
        public bool InitialState
        {
            ...
            set
            {
                this.Delta(ref this.m_InitialState, value);
            }
        }
        public int SwitchID
        {
            ...
            set
            {
                this.Delta(ref this.m_SwitchID, value);
            }
        }
        public override string Compile()
        {
            return String.Format("{{ radio {0} {1} {2} {3} {4} {5} }}", this.m_X, this.m_Y, this.m_ID1, this.m_ID2, this.m_InitialState ? 1 : 0, this.m_SwitchID);
        }
