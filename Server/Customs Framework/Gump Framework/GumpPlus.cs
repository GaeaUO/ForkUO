...
namespace CustomsFramework.GumpPlus
{
    ...
    public abstract partial class GumpPlus : Gump
    {
        ...
        {
            this.Add(new ButtonPlus(x, y, normalID, pressedID, buttonID, String.Format("Button:{0}", buttonID), this.DefaultButtonHandler));
        }

        public void AddButton(int x, int y, int normalID, int pressedID, string name, ButtonResponse callback)
        {
            this.Add(new ButtonPlus(x, y, normalID, pressedID, (this._EnableMacroProtection ? this.RandomButtonID() : this.NewButtonID()), name, callback));
        }

        public void AddButton(int x, int y, int normalID, int pressedID, string name, ButtonParamResponse callback, object param)
        {
            this.Add(new ButtonPlus(x, y, normalID, pressedID, (this._EnableMacroProtection ? this.RandomButtonID() : this.NewButtonID()), name, callback, param));
        }
        ...
        {
            this.Add(new TextEntryPlus(x, y, width, height, hue, String.Format("TextEntry:{0}", entryID), entryID, initialText, this.DefaultTextInputResponse));
        }
        ...
        {
            this.AddTextEntry(x, y, width, height, hue, name, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, callback);
        }
        ...
        {
            this.AddTextEntry(x, y, width, height, hue, name, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, callback, param);
        }
        ...
        {
            this.AddTextEntry(x, y, width, height, hue, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, callback);
        }
        ...
        {
            this.AddTextEntry(x, y, width, height, hue, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, callback, param);
        }
        ...
        {
            this.Add(new TextEntryLimitedPlus(x, y, width, height, hue, String.Format("LimitedTextEntry:{0}", entryID), entryID, initialText, size, this.DefaultLimitedTextInputResponse));
        }
        ...
        {
            this.AddLimitedTextEntry(x, y, width, height, hue, name, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, size, callback);
        }
        ...
        {
            this.AddLimitedTextEntry(x, y, width, height, hue, name, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), intialText, size, callback, param);
        }
        ...
        {
            this.AddLimitedTextEntry(x, y, width, height, hue, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, size, callback);
        }
        ...
        {
            this.AddLimitedTextEntry(x, y, width, height, hue, (this._EnableMacroProtection ? this.NewTextEntryID() : this.RandomTextEntryID()), initialText, size, callback, param);
        }
        ...
        {
            this.Add(new CheckPlus(x, y, inactiveID, activeID, initialState, switchID, String.Format("Check:{0}", switchID), 0, this.DefaultCheckResponse));
        }
        ...
        {
            this.AddCheck(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewSwitchID() : this.RandomSwitchID()), name, group, callback);
        }
        ...
        {
            this.AddCheck(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewSwitchID() : this.RandomSwitchID()), name, group, callback, param);
        }
        ...
        {
            this.AddCheck(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewSwitchID() : this.RandomSwitchID()), group, callback);
        }
        ...
        {
            this.AddCheck(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewSwitchID() : this.RandomSwitchID()), group, callback, param);
        }
        ...
        {
            this.Add(new RadioPlus(x, y, inactiveID, activeID, initialState, switchID, 0, String.Format("Radio:{0}", switchID), this.DefaultRadioResponse));
        }
        ...
        {
            this.AddRadio(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewRadioID() : this.RandomRadioID()), group, name, callback);
        }
        ...
        {
            this.AddRadio(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewRadioID() : this.RandomRadioID()), group, name, callback, param);
        }

        public void AddRadio(int x, int y, int inactiveID, int activeID, bool initialState, int group, RadioResponse callback)
        {
            this.AddRadio(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewRadioID() : this.RandomRadioID()), group, callback);
        }
        ...
        {
            this.AddRadio(x, y, inactiveID, activeID, initialState, (this._EnableMacroProtection ? this.NewRadioID() : this.RandomRadioID()), group, callback, param);
        }
