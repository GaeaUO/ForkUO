    ...
    public class Resources
    {
        ...
        public static void Configure()
        {
            ...
            ResourceTypes.Add(new ResourceType("Metal",
                new ResourceInfo(1053109, "Iron", 0x0, 0.0, CraftAttributeInfo.Blank, typeof(IronOre), typeof(IronIngot), false, 1042853),
                new ResourceInfo(1053108, "Dull Copper", 0x973, 65.0, CraftAttributeInfo.DullCopper, typeof(DullCopperOre), typeof(DullCopperIngot), false, 1042845),
                new ResourceInfo(1053107, "Shadow Iron", 0x966, 70.0, CraftAttributeInfo.ShadowIron, typeof(ShadowIronOre), typeof(ShadowIronIngot), false, 1042846),
                new ResourceInfo(1053106, "Copper", 0x96D, 75.0, CraftAttributeInfo.Copper, typeof(CopperOre), typeof(CopperIngot), false, 1042847),
                new ResourceInfo(1053105, "Bronze", 0x972, 80.0, CraftAttributeInfo.Bronze, typeof(BronzeOre), typeof(BronzeIngot), false, 1042848),
                new ResourceInfo(1053104, "Golden", 0x8A5, 85.0, CraftAttributeInfo.Golden, typeof(GoldOre), typeof(GoldIngot), false, 1042849),
                new ResourceInfo(1053103, "Agapite", 0x979, 90.0, CraftAttributeInfo.Agapite, typeof(AgapiteOre), typeof(AgapiteIngot), false, 1042850),
                new ResourceInfo(1053102, "Verite", 0x89F, 95.0, CraftAttributeInfo.Verite, typeof(VeriteOre), typeof(VeriteIngot), false, 1042851),
                new ResourceInfo(1053101, "Valorite", 0x8AB, 99.0, CraftAttributeInfo.Valorite, typeof(ValoriteOre), typeof(ValoriteIngot), false, 1042852)));
            ...
            ResourceTypes.Add(new ResourceType("Wood",
                new ResourceInfo(1011542, "Normal", 0x0, 0.0, CraftAttributeInfo.Blank, typeof(Log), typeof(Board), true, 1027134),
                new ResourceInfo(1072533, "Oak", 0x7DA, 65.0, CraftAttributeInfo.OakWood, typeof(OakLog), typeof(OakBoard), true, 1075063),
                new ResourceInfo(1072534, "Ash", 0x4A7, 80.0, CraftAttributeInfo.AshWood, typeof(AshLog), typeof(AshBoard), true, 1075064),
                new ResourceInfo(1072535, "Yew", 0x4A8, 95.0, CraftAttributeInfo.YewWood, typeof(YewLog), typeof(YewBoard), true, 1075065),
                new ResourceInfo(1072536, "Heartwood", 0x4A9, 100.0, CraftAttributeInfo.Heartwood, typeof(HeartwoodLog), typeof(HeartwoodBoard), true, 1075066),
                new ResourceInfo(1072538, "Bloodwood", 0x4AA, 100.0, CraftAttributeInfo.Bloodwood, typeof(BloodwoodLog), typeof(BloodwoodBoard), true, 1075067),
                new ResourceInfo(1072539, "Frostwood", 0x47F, 100.0, CraftAttributeInfo.Frostwood, typeof(FrostwoodLog), typeof(FrostwoodBoard), true, 1075068)));
