...
namespace Server.Harvest
{
    public class Vein
    {
        ...
        public IResource Consume(Boolean mutate, Boolean FeluccaRules, Race race)
        {
            ...
            ResourceInfo info = (!mutate ? _info : ResourceService.Service.Mutate("BLAH BLAH", _info.ResourceName));

            if (Utility.RandomDouble() <= _defaultChance - (race == Race.Elf ? 0.03 : 0))
                info = ResourceService.Service.DefaultResource("BLAH BLAH");
            ...
            get
            {
                ...
                else if (_respawnTime < DateTime.Now)
                {
                    ...
                    if (1 == 1) // TO DO - Randomize check
                        _info = ResourceService.Service.RandomResource("BLAH BLAH");
                }
        ...
        public void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(_info.ResourceName);
        ...
        private void Deserialize(GenericReader reader)
        {
            ...
            {
                case 0:
                    _info = ResourceService.Service.LookupResource("BLAH BLAH", reader.ReadString());
