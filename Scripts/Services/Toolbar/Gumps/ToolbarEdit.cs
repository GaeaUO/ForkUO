...
namespace Services.Toolbar.Gumps
{
	public class ToolbarEdit : Gump
	{
		...
		public void AddControls()
		{
			...
			AddLabel(274, 36, 0, String.Format("Rows - {0}", _Info.Dimensions[1]));
			...
			AddLabel(274, 61, 0, String.Format("Columns - {0}", _Info.Dimensions[0]));

			if (_Info.Dimensions[0] < 9)
				AddButton(359, 60, 2435, 2436, 5, GumpButtonType.Reply, 0);
			if (_Info.Dimensions[0] > 1)
