...
namespace Services.Toolbar.Core
{
    ...
    {
        public const string SystemVersion = "2.0";
        public const string ReleaseDate = "December 21, 2012"; // So much for the end of the world...
        ...
        {
            ToolbarModule module = World.GetModule(from) as ToolbarModule;
